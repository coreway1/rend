...
function DisplayLocations(props) {
  ...
  if (saveloading) return <p>Loading propss...</p>;
...
export function ProductsCard() {
  ...
  const toggleActive = useCallback(() => setsaveloading((saveloading) => !saveloading), []);
  ...
  return (
    <>
    <DisplayLocations  saveloading={saveloading}/>
      {toastMarkup}
      <Card title="Product Counter" sectioned>
        <TextContainer spacing="loose">
          ...
          <Button primary onClick={toggleActive}>Test</Button>
          <Button
            primary
            loading={loading}
            onClick={() => {
